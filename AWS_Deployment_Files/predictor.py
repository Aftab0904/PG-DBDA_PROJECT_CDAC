...
driver_dict = pickle.load(open('C:/DE/CDAC-PROJECT/for_ec2/dictionary/driver_dict','rb'))
constructor_dict = pickle.load(open('C:/DE/CDAC-PROJECT/for_ec2/dictionary/constructor_dict','rb'))
clf = pickle.load(open('C:/DE/CDAC-PROJECT/for_ec2/raoforest.pkl','rb'))

data = pd.read_csv("C:/DE/CDAC-PROJECT/for_ec2/cleaned_data.csv")

y_dict = {1:'Podium Finish [1-3]',
          2:'Points Finish [4-10]',
          3:'No Points Finish [10+]'        
        }
